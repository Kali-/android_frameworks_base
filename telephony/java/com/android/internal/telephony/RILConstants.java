...
*/
    ...
    int RIL_REQUEST_STK_APP_INIT_COMPLETED = 109;
    int RIL_REQUEST_GET_MODEM_VERSION = 126;
    int RIL_REQUEST_GET_HW_VERSION = 127;
    int RIL_REQUEST_GET_FACTORY_VERSION = 128;
    int RIL_REQUEST_GET_LINE_SELECT_INFO = 133;
